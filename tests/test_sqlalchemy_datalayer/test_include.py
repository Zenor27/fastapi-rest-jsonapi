        ...
        "included": [
            {
                "type": "comment",
                "id": 1,
                "attributes": {"text": "comment 0", "author_id": 1},
            },
            {
                "type": "comment",
                "id": 2,
                "attributes": {"text": "comment 1", "author_id": 2},
            },
        ],
    }
...
def test_include_list(client: TestClient, articles, comments):
    ...
    assert response.json() == {
        ...
        "included": [
            ...
            {
                "type": "comment",
                "attributes": {"text": "comment 2", "author_id": 3},
                "id": 3,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 3", "author_id": 4},
                "id": 4,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 4", "author_id": 5},
                "id": 5,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 5", "author_id": 6},
                "id": 6,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 6", "author_id": 7},
                "id": 7,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 7", "author_id": 8},
                "id": 8,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 8", "author_id": 9},
                "id": 9,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 9", "author_id": 10},
                "id": 10,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 10", "author_id": 11},
                "id": 11,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 11", "author_id": 12},
                "id": 12,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 12", "author_id": 13},
                "id": 13,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 13", "author_id": 14},
                "id": 14,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 14", "author_id": 15},
                "id": 15,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 15", "author_id": 16},
                "id": 16,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 16", "author_id": 17},
                "id": 17,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 17", "author_id": 18},
                "id": 18,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 18", "author_id": 19},
                "id": 19,
            },
            {
                "type": "comment",
                "attributes": {"text": "comment 19", "author_id": 20},
                "id": 20,
            },
        ],
    }
...
def test_simple_include_with_fields(client: TestClient, articles, comments):
    response: Response = client.get(
        "/articles/1?include=comments&fields[comment]=text&fields[article]=name,comments"
    )
    assert response.status_code == status.HTTP_200_OK
    assert response.json() == {
        "data": {
...
def test_simple_include_with_fields_no_relationship(
    client: TestClient, articles, comments
):
    response: Response = client.get(
        "/articles/1?include=comments&fields[comment]=text&fields[article]=name"
    )
    assert response.status_code == status.HTTP_200_OK
    assert response.json() == {
        "data": {
...
def test_simple_include_with_fields_no_include_bad_field(
    ...
    response: Response = client.get(
        "/articles/1?fields[comment]=text&fields[article]=name,comments"
    )
